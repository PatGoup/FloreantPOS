...
public class PosButtonWL extends JButton {
	...
	public PosButtonWL(String text) {
		super(text);
	...
	public PosButtonWL(String text, Action action) {
		super(action);
		setText(text);
	...
	public PosButtonWL(ActionCommand command) {
		this(command.toString());

		setActionCommand(command.name());
	}

	public PosButtonWL(String text, ActionCommand command) {
		this(text);

		setActionCommand(command.name());
	}

	public PosButtonWL(ActionCommand command, ActionListener listener) {
		this(command.toString());
	...
	public PosButtonWL(ImageIcon imageIcon) {
		super(imageIcon);
		setFocusable(false);
		setFocusPainted(false);
	}
