...
import com.floreantpos.model.base.BaseBookingCustomerInfo;


public class BookingCustomerInfo extends BaseBookingCustomerInfo {
	 ...
	 */
	public BookingCustomerInfo (java.lang.Integer id) {
		super(id);
	}

	/*[CONSTRUCTOR MARKER END]*/
	public String toString() {
	//	return getBookingtId().toString();
        return null;        //??????
	}
