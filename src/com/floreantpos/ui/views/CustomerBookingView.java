...
***************************/
	...
	public static CustomerBookingView getInstance() {
		if (instance == null) {
			instance = new CustomerBookingView();
		}
	//instance.customerSelector.setOrderType(orderType);
	instance.customerSelector.setOrderType(null);
