...
public abstract class SelectionView extends JPanel implements ComponentListener {
	...
	//???  need a wraplayout for categoryview
	//??? 
	protected WrapLayout wrapLayout = new WrapLayout ();
	private JPanel wrapLayoutContainer = new JPanel(wrapLayout);
	...
	public void setCategoryView (boolean  isCategoryView)
    {
        this.isCategoryView = isCategoryView;
        
        // when creating buttons separate buttons into cardlayoutcontainer and wraplayoutcontainer
//        buttonPanelContainer.removeAll();
  //      buttonPanelContainer.add(wrapLayoutContainer);
    }    
