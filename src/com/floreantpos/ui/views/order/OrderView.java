...
public class OrderView extends ViewPanel implements PaymentListener, TicketEditListener, RefreshableView {
	...
	public TransparentPanel midContainer = new TransparentPanel(new BorderLayout(5, 5));//???
	...
	private void initComponents() {
        ...
        midContainer.add (scrlPane);     //???
		
		pnlNorth.add (categoryView, BorderLayout.NORTH);	//???	
		
		pnlNorth.add (groupView, BorderLayout.SOUTH);      //???
		//???*** borderlayout east border modifiers 
        //???  modifierselectiondialog  ???  this.borderlayout.east ???
		//		add(categoryView, java.awt.BorderLayout.EAST);
		
		pnlCenter.add (itemView);        //???
